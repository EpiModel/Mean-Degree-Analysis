...
TO DO: 1. Hide output from code chunks, 2. How to create numbered lists
...
```{r ARTnet-RADAR_Netparams_Script, eval=FALSE}
...
# Overall
md.overall.main.ARTnet_script <- out$main$md.main
md.overall.casl.ARTnet_script <- out$casl$md.casl
md.overall.inst.ARTnet_script <- out$inst$md.inst

# By Age Group
md.age.main.ARTnet_script <- out$main$nf.age.grp
md.age.casl.ARTnet_script <- out$casl$nf.age.grp
md.age.inst.ARTnet_script <- out$inst$nf.age.grp

# By Race
md.race.main.ARTnet_script <- out$main$nf.race
md.race.casl.ARTnet_script <- out$casl$nf.race
md.race.inst.ARTnet_script <- out$inst$nf.race

# By Diagnosed HIV Status
md.HIV_status.main.ARTnet_script <- out$main$nf.diag.status
md.HIV_status.casl.ARTnet_script <- out$casl$nf.diag.status
md.HIV_status.inst.ARTnet_script <- out$inst$nf.diag.status

# By Cross Partnership Degree
md.casl_cross_deg.main.ARTnet_script <- out$main$nf.deg.casl
md.main_cross_deg.casl.ARTnet_script <- out$casl$nf.deg.main


## Proportion Concurrent
prop.concurrent.main.ARTnet_script <- out$main$concurrent
prop.concurrent.casl.ARTnet_script <- out$casl$concurrent
prop.concurrent.inst.ARTnet_script <- out$inst$concurrent


## Mixing

# By Age - Overall
mixing.age.overall.main.ARTnet_script <- out$main$nm.age.grp_diffF
mixing.age.overall.casl.ARTnet_script <- out$casl$nm.age.grp_diffF
mixing.age.overall.inst.ARTnet_script <- out$inst$nm.age.grp_diffF

# By Age - Within Age Group
mixing.age.within_group.main.ARTnet_script <- out$main$nm.age.grp
mixing.age.within_group.casl.ARTnet_script <- out$casl$nm.age.grp
mixing.age.within_group.inst.ARTnet_script <- out$inst$nm.age.grp
