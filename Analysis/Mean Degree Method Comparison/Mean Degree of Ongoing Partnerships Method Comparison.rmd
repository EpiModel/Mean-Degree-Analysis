...
mean.degree.main <- c(round(out_dos$main$md.main,4), round(out_list[[3]][[1]][[1]][1],4))
colnames(mean.degree.main) <- c("Day-of-Survey", "Three-Month")

mean.degree.casl <- c(round(out_dos$casl$md.casl,4), round(out_list[[3]][[2]][[1]][1],4))
