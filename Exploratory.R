...
write_xlsx(all, "all.xlsx")
write_xlsx(race.cat, "race.xlsx")
write_xlsx(age.cat, "age.xlsx")
write_xlsx(region, "region.xlsx")
write_xlsx(income, "income.xlsx")
write_xlsx(education, "education.xlsx")
